...
def get_user_inputs(prefix="input"):
    return {
        ...
        'sex': st.sidebar.selectbox('Sex', {0: 'Female', 1: 'Male'}, key=f"{prefix}_sex"),
        ...
        'fbs': st.sidebar.selectbox('Fasting Blood Sugar >120', {0: 'No', 1: 'Yes'}, key=f"{prefix}_fbs"),
        'restecg': st.sidebar.selectbox('ECG Results', {
            0: 'Normal',
            1: 'ST-T wave abnormality',
            2: 'Left ventricular hypertrophy'
        }, key=f"{prefix}_restecg"),
        'thalach': st.sidebar.number_input('Max Heart Rate', 60, 220, 150, key=f"{prefix}_thalach"),
        'exang': st.sidebar.selectbox('Exercise Angina', {0: 'No', 1: 'Yes'}, key=f"{prefix}_exang"),
